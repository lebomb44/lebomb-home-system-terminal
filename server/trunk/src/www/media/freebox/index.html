...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" lang="fr">
  <head>
        ...
        <style type="text/css" media="screen">@import "http://lebomb.free.fr/APP/www_/media/freebox/css/reset.css";</style>
        <style type="text/css" media="screen">@import "http://lebomb.free.fr/APP/www_/media/freebox/css/freecommande-v2.css";</style>
        <script src="http://lebomb.free.fr/APP/www_/media/freebox/js/jquery-1.4.2.min.js" type="text/javascript" charset="utf-8"></script>
        <script src="http://lebomb.free.fr/APP/www_/media/freebox/js/jquery.cookies.2.2.0.min.js" type="text/javascript" charset="utf-8"></script>
        <script src="http://lebomb.free.fr/APP/www_/media/freebox/js/jquery.timers.js" type="text/javascript" charset="utf-8"></script>
        <script src="http://lebomb.free.fr/APP/www_/media/freebox/js/freecommande.js" type="text/javascript" charset="utf-8"></script>
        <link rel="apple-touch-icon-precomposed" href="http://lebomb.free.fr/APP/www_/media/freebox/images/icon-freecommande.png" />
        <link rel="apple-touch-startup-image" href="http://lebomb.free.fr/APP/www_/media/freebox/images/startup-freecommande.png" />
